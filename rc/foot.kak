...
define-command -override foot-terminal -params .. -shell-completion -docstring 'foot-terminal <program> [arguments]: create a new terminal as a foot window' %{
	foot %opt{foot_normal_cmd} %opt{foot_normal_flags} %arg{@}
}

define-command -override foot-terminal-popup -params .. -shell-completion -docstring 'foot-terminal-popup <program> [arguments]: create a new terminal as a foot window (with foot_popup_flags)' %{
	foot %opt{foot_popup_cmd} %opt{foot_popup_flags} %arg{@}
}

define-command -override foot-terminal-panel -params .. -shell-completion -docstring 'foot-terminal-popup <program> [arguments]: create a new terminal as a foot window (with foot_panel_flags)' %{
